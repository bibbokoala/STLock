...
((function ( $ ) {
  ...
  $.widget('aerolab.blockrain', {
    ...
    options: {
      ...
      theme: 'yellow' , //null, 'gameboy', // The theme name or a theme object
      ...
      this._board = {
        ...
        animate: function() {
          ...
          if( gameOver ) {
			...
			//SIMONE AGGIORNO LA LABEL DELLA VELOCITA
			$('.blockrain-speed-num').html(game.options.speed);
    ...
    _createUI: function() {
      ...
      // Speed
      game._$speed = $(
        '<div class="blockrain-speed-holder" style="position: absolute;">'+
          '<div class="blockrain-speed">'+
            '<div class="blockrain-speed-msg">'+ this.options.speedText +'</div>'+
            '<div class="blockrain-speed-num">'+ this.options.speed +'</div>'+
          '</div>'+
        '</div>').hide();
      game._$speedText = game._$speed.find('.blockrain-speed-num');
      game._$gameholder.append(game._$speed);
